...
To determine whether there is a linear association between distance from the plant and number of sneezes, a Pearson’s product-moment correlation was conducted, as both variables are continuous and approximately linearly related.

Null hypothesis (H₀): There is no correlation between distance and sneezes (ρ = 0).

Alternative hypothesis (H₁): There is a non-zero correlation between distance and sneezes (ρ ≠ 0).

The test yielded a statistically significant result: t(34) = –2.71, p = .0105. The estimated correlation coefficient was r = –0.42 with a 95% confidence interval [–0.66, –0.11], indicating a moderate negative linear relationship (Field, 2013). As distance from the plant increases, the number of sneezes tends to decrease.

Thus, the data provide evidence of a meaningful negative relationship between proximity to the plant and allergic response, supporting Foxy's suspicion.
